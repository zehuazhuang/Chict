...
class OrtailoREdsReport extends StatefulWidget {
  const OrtailoREdsReport({super.key});

  @override
  State<OrtailoREdsReport> createState() => _OrtailoREdsReport();
}

class _OrtailoREdsReport extends State<OrtailoREdsReport> {
  List<String> thSTUrili = [
    "Vulgar pornographic content",
    "Plagiarized and infringing content",
                ...
                child: Padding(
                  ...
                  child: Flex(
                    ...
                    children: [
                      ...
                      Flex(
                        direction: Axis.vertical,
                        children: List.generate(thSTUrili.length, (index) {
                          return Padding(
                                  ...
                                  child: Row(
                                    ...
                                    children: [
                                      ...
                                      Container(
                                        ...
                                        child: Visibility(
                                          visible: seLEDEX == index,
                                          child: Image.asset(
                                            "assets/images/NFIUQWDH.png",
                                            width: 14,
                                            height: 12,
                                          ),
                                        ),
                      ...
                      Align(
                        ...
                        child: GestureDetector(
                          ...
                          onTap: () async {
                            ...
                            Future.delayed(
                              const Duration(milliseconds: 1329),
                              () {
